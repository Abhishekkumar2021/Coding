...
Note:
I) A palindrome is a word, number, phrase, or another sequence of
characters that reads the same backward as forward, such as 'naman '
' abcba', ' 1234321', etc
2) The numerical value of the given string 'S' will be greater than e.
3) A single-digit number is also considered as a palindrome.
4) Note that the length of the string 'S' is nothing but the number of
